final String appName = 'Vizzve Driver Partner';

// final String baseUrl = 'https://alphawizztest.tk/Vizzv_food/delivery_boy/app/v1/api/';
final String baseUrl = 'https://vizzvefoods.com/delivery_boy/app/v1/api/';
