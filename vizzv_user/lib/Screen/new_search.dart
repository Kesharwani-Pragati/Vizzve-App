...
class _NewSearchState extends State<NewSearch> {
  ...
  getSearch()async{
    ...
    Map data =await apiBaseHelper.postAPICall(Uri.parse(baseUrl+"search_restaurant"), param);
    print(data);
    setState(() {
      loading = false;
    });
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            icon: Icon(Icons.arrow_back_sharp,color: colors.primary,),
            onPressed: (){
              if(searchList.length>0){
                setState(() {
                  searchList.clear();
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            child: !loading?searchList.length>0?Column(
              children: [
                ListView.builder(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Expanded(child: Text(searchList[index].store_name.toString(),style: Theme.of(context).textTheme.titleMedium,)),
                                      ...
                                      children: [
                                        ...
                                        Expanded(child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text("₹"+searchList[index].prVarientList![0].price.toString(),style: Theme.of(context).textTheme.bodyMedium,),
                                            Row(
                                              children: [
                                                Container(
                                                    decoration: BoxDecoration(
  ...
  void getSeller(sellerId) {
    ...
    apiBaseHelper.postAPICall(getSellerApi, parameter).then((getdata) {
      ...
      if (!error) {
        ...
        if (sellerList1[0].open_close_status ==
            "1") {
          Navigator.push(
              context,
              MaterialPageRoute(
