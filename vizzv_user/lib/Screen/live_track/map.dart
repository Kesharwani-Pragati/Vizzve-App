...
class MapPage extends StatefulWidget {
  ...
  bool live;
  String? id;
  MapPage(this.status,{ this.SOURCE_LOCATION, this.DEST_LOCATION,required this.live,this.id});
    ...
    return Stack(
      ...
      children: [
        ...
        Container(
          ...
          child: Text("Estimate Time : ${approxTime}",style: TextStyle(color: Colors.white),),
        ),
